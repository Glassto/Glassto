  ...
  return (
    <div className=" py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="text-center text-lg/8 paragraph-gradient bg-clip-text text-transparent font-semibold">
          We are using the latest and the most innovative frameworks available:
        </h2>
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-2 items-center place-items-center gap-x-8 gap-y-10 sm:max-w-xl sm:gap-x-10 lg:mx-0 lg:max-w-none sm:grid-cols-3">
          <div className="flex items-center gap-2">
            ...
            >
              <circle
                ...
                r="2"
                fill="currentColor"
                className="fill-[#58C4DC]"
              ></circle>
              <g
                stroke="currentColor"
                stroke-width="1"
                fill="none"
                className="stroke-[#58C4DC]"
              >
            ...
            <h2 class="font-display text-2xl self-center flex font-medium leading-snug text-slate-200">
              React
            </h2>
          </div>
