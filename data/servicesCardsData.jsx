export const servicesCardsData = [
  {
    ...
    points: [
      ...
      "Niche authority (increased trust and brand awareness).",
      "Perfect compatibility with other digital strategies (PPC, Social Media).",
      "Higher conversion rates (targets users with specific search intent).",
    ],
  },
  {
    id: 2,
    ...
    description:
      "Create powerful websites that work perfectly on all devices. We build custom solutions with strong security features and smooth functionality, ensuring your site grows alongside your business needs.",
    pointsTitle:
      "Professional web development ensures future-ready solutions like:",
    points: [
